...
// you know that no one who isnt bored out of their fucking mindo or trying to pretend that they are writing code read this right?
//i understand that you put it here in hopes that someone wil read this and make use of it to better their project but thats not what hapends kiddo
//im upset
//im not good enough
//im not a good person i just make good grades
//fuck off
//they could kick me out and be all the better for it
// i just waste time and make everyone the worse for it
...
motor(port2) = 110;
motor(port9) = -127;
wait1Msec(2850); //sends robot back to near starting point
motor(port6) = -127;
wait1Msec(500); //drop elevator releasing the mobile cone
motor (port6) =0;
wait1Msec(100);
motor(port1) = 127;
motor(port10) = -127;
