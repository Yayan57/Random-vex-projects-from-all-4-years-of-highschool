...
motor(port2) = -127;
motor(port9) = 127;
wait1Msec(1700); //sends robot back to near starting point
motor(port7) = 80;
motor (port8) = -80;
wait1Msec(300); //drop elevator releasing the mobile cone
motor (port7) =0;
motor (port8) =0;
wait1Msec(100);
motor(port1) = -127;
...
// .....................................................................................
	...
	if (vexRT[Btn8D] ==1) //if button 8r is pressed elevator goes up
	{
		motor(port7) = 80;
		motor(port8) = -80; // .. raise the elevator
	}
	else if (vexRT[Btn8U] ==1) // if button 8d is pressed elevator goes down
	{
		motor(port7) = -80;
