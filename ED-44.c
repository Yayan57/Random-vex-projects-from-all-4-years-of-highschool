...
#pragma config(Motor,  port5,           topleft,       tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port6,           BottomLeft,    tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port7,           liftright,     tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port8,           liftleft,      tmotorVex393_MC29, openLoop, reversed)
