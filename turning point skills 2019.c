...
motor(port1)=  127;
motor(port5)=  127;
motor(port6)=  127; // drive toward bottom flag
wait1Msec(1200);
...
motor(port1)=-127;
motor(port5)=-127;
motor(port6)=127;//turn 135 degrees where shooter faces top right base		//left
...
motor(port1)=  -127;
motor(port5)=  -127;
motor(port6)=  -127;//drive toward top right base
wait1Msec(1500);
